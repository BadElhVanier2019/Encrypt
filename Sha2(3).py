...
class SHA256:
    def __init__(self, message):
        ...
        :param message: This is the message to be hashed and salted using sha256

        This class will have 3 attributes:
        self.saltval : The salt value which is appended to the end of the message to generate
                        the salt value.
        self.finalsalt: The hashed salted value. This is the hash value of the saltval appended
                        to the end of the message.
        self.finalhash : The hashed value of the message.
        """

        self.saltval = op.bintohex(op.inttobin(getrandbits(128)))
        ...
        # deletes the original message so its not accessible
        self.originalmessage = ""
        self.message = ""

    def send(self, serverIP, message):
        """
